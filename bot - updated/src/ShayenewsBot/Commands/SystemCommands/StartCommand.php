...
class StartCommand extends SystemCommand
{
    ...
    public function execute()
    {
		...
		if (empty($host)){
            ...
            $result = MyDB::insertChatDetails($this->getMessage()->getChat(), ['host_id' => $host_id, 'lang' => 'fa', 'satoshi' => 200, 'ads_seen' => 0]);
		} else {
            $result = MyDB::insertChatDetails($this->getMessage()->getChat(), ['host_id' => $host_id, 'lang' => 'fa']);
		}
