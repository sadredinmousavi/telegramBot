        ...
        switch ($lang) {
            case 'fa':
                $strings = array(
                    ...
                    'menu_3_2'       => json_decode('"\u2753"') .' ' .'راهنما',
                    'menu_3_1'       => json_decode('"\uD83D\uDD10"') .' ' .'دستورات ادمین',
                    'menu_2_1'       => json_decode('"\uD83D\uDC6B"') .' ' .'دعوت دوستان',
                    'menu_1'         => json_decode('"\uD83C\uDFA8"') .' ' .'ایجاد پست جدید',
                    'menu_2_2'       => json_decode('"\uD83D\uDCB0"') .' ' .'کيف پول',
                    ...
                    //
                    'banner_text'    => 'ربات هواداری شایعه نیوز' .PHP_EOL .'%s',
                    //
                    ...
                    //
                    'newpost_0_intro'            => 'ابتدا مدیا خود را ارسال کنید.' .PHP_EOL .'(می توانید فوروارد کنید)' .PHP_EOL .'مدیا می تواند عکس، قیلم و یا از هر نوع دیگر باشد.' .PHP_EOL .PHP_EOL .'براي بازگشت از دستور' .' /cancel ' .'استفاده کنيد.',
                    'newpost_0_error'            => 'خطایی رخ داده. لطفا مجددا تلاش نمایید.',
                    'newpost_0_skey'             => 'لطفا فقط یک مدیا بفرستید.' .PHP_EOL .'براي بازگشت از دستور' .' /cancel ' .'استفاده کنيد.',
                    'newpost_1_nocaption'        => 'کپشن ندارم',
                    'newpost_1_intro'            => 'لطفا یک متن برای کپشن مدیا بفرستید.' .PHP_EOL .'اگر متن بیشتر از 250 کاراکتر باشد مدیا به صورت خودکار پایین متن خواهد رفت.' .PHP_EOL  .'در صورتی که می خواهید مدیا بدون کپشن باشد دکمه ' .' "%s" ' .' از کیبورد زیر را فشار دهید' .PHP_EOL .'براي بازگشت از دستور' .' /cancel ' .'استفاده کنيد.',
                    'newpost_1_skey'             => 'لطفا فقط متن کپشن را بفرستید.' .PHP_EOL .'در صورتی که می خواهید مدیا بدون کپشن باشد دکمه ' .' "%s" ' .' از کیبورد زیر را فشار دهید' .PHP_EOL .'براي بازگشت از دستور' .' /cancel ' .'استفاده کنيد.',
                    'newpost_2_intro'            => 'لطفا اگر اصلاحات کامل شده با کمک دکمه ' .' "%s" ' .'کار خود را ذخیره و سپس استفاده کنید.' .PHP_EOL .'در غیر این صورت از دکمه های کیبورد زیر استفاده کنید.',
                    'newpost_2_skey'             => 'لطفا تنها از دکمه های کیبورد استفاده کنید.' ,
                    'newpost_2_butt1'            => json_decode('"\uD83D\uDD17"') .' ' .'افزودن دکمه لینک دار',
                    'newpost_2_butt2'            => json_decode('"\uD83D\uDCDD"') .' ' .'اصلاح مجدد متن',
                    'newpost_2_butt3'            => json_decode('"\uD83D\uDCBE"') .' ' .'ذخیره و پایان',
                    'newpost_2_concu'            => 'شما حداکثر می توانید چهار خط دکمه که در هر خط سه ردیف دکمه هستند را به زیر پست اضافه کنید.' .PHP_EOL .'در حالت حداکثری دکمه ها به صورت زیر خواهند بود' .PHP_EOL .PHP_EOL .'(-)(-)(-)' .PHP_EOL .'(-)(-)(-)' .PHP_EOL .'(-)(-)(-)' .PHP_EOL .'(-)(-)(-)',
                    'newpost_3_butt1'            => json_decode('"\u274E"') .' ' .'اتمام دکمه ها',
                    'newpost_3_butt2'            => json_decode('"\uD83D\uDCDD"') .' ' .'اصلاح مجدد دکمه ها',
                    'newpost_3_intro'            => 'حالا اطلاعات مربوط به دکمه های خط ' .' "%d" ' .'را فقط در قالب زیر وارد کنید.' .PHP_EOL .'قالب ورود اطلاعات  - حداکثر 3 دکمه  :' .PHP_EOL .'بخش ها با اینتر جدا شوند.'.PHP_EOL .PHP_EOL .'متن دکمه 1' .PHP_EOL .'لینک دکمه 1' .PHP_EOL .'متن دکمه 2' .PHP_EOL .'لینک دکمه 2' .PHP_EOL .'متن دکمه 3' .PHP_EOL .'لینک دکمه 3' .PHP_EOL .PHP_EOL .'در صورتی که اصلاح و اضافه کردن کلید تمام شده از دکمه های کیبورد اصتفاده کنید. در غیر این صورت تنها پیعام متنی را به ربات بفرستید.' .PHP_EOL .PHP_EOL .'نکته مهم : اگر آدرس ها نا معتبر باشند تلگرام خطا خواهد داد و باید از اول دکمه ها را تعریف کنید.',
                    'newpost_3_skey1'            => 'لطفا تنها پیغام متنی بفرستید.' .PHP_EOL .'حالا اطلاعات مربوط به دکمه های خط ' .' "%d" ' .'را فقط در قالب زیر وارد کنید.' .PHP_EOL .'قالب ورود اطلاعات  - حداکثر 3 دکمه  :' .PHP_EOL .'بخش ها با اینتر جدا شوند.'.PHP_EOL .PHP_EOL .'متن دکمه 1' .PHP_EOL .'لینک دکمه 1' .PHP_EOL .'متن دکمه 2' .PHP_EOL .'لینک دکمه 2' .PHP_EOL .'متن دکمه 3' .PHP_EOL .'لینک دکمه 3' .'برای لغو دستور بدون ذخیر از دستور' .' /cancel ' .'استفاده کنید.',
                    'newpost_3_preview'          => 'پیش نمایش دکمه های خط شماره' .' "%d" ' .' :',
                    'newpost_3_error'            => 'خطا در ساخت دکمه ها. لازم است از اول دکمه ها را تعریف کنید.',
                    'newpost_7_intro'            => 'اگر اصلاحی لازم دارد از کیبورد زیر استفاده کنید.' .PHP_EOL .'در غیر این صورت برای استفاده از پست در چت های دیگر از دکمه' .' "%s" ' .'از کیبورد استفاده کنید.',
                    'newpost_7_skey'             => 'لطفا فقط از کیبورد زیر استفاده کنید.' .PHP_EOL .'در غیر این صورت برای استفاده از پست در چت های دیگر از دکمه' .' "%s" ' .'از کیبورد استفاده کنید.',
                    'newpost_7_butt1'            => json_decode('"\uD83D\uDCDD"') .' ' .'اصلاح مجدد دکمه ها',
                    'newpost_7_butt2'            => json_decode('"\uD83D\uDCDD"') .' ' .'اصلاح مجدد متن',
                    'newpost_7_butt3'            => json_decode('"\uD83D\uDCBE"') .' ' .'ذخیره و پایان',
                    'newpost_8_intro'            => 'برای استفاده در چت ها کافیه فقط کد زیر رئ تایپ کنید ولی ارسال نکنید. پست شما توی کیبورد نشون داده میشه که باید روی اون کلیک کنید.' .json_decode('"\uD83C\uDF39"'),
                    'newpost_8_concu'            => '%s',
                    'newpost_8_butt1'            => json_decode('"\uD83D\uDC7E"') .' ' .'استفاده در چت ها',
                    //
                );
                break;
