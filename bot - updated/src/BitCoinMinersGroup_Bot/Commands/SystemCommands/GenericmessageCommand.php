...
class GenericmessageCommand extends SystemCommand
{
    ...
    public function execute()
    {
        ...
        switch ($text){
            case $strings['menu_banner']:
                return $this->getTelegram()->executeCommand("banner");
                break;
            case $strings['menu_myscore']:
                return $this->getTelegram()->executeCommand("myscore");
                break;
            case $strings['menu_language']:
                return $this->getTelegram()->executeCommand("setlang");
                break;
            case $strings['menu_help']:
                return $this->getTelegram()->executeCommand("help");
                break;
            case $strings['menu_wallet']:
                return $this->getTelegram()->executeCommand("wallet");
                break;
            default:
