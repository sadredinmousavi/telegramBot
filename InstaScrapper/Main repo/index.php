...
<head>
    ...
    <title>InstaBot tushy lover</title>
    <!--[if lt IE 9]>
                    ...
                    <form class="navbar-form">
                        <div class="form-group" style="display:inline;">
                            <div class="input-group" style="display:table;">
                                <input class="form-control" id="txtSearch" name="txtSearch" placeholder="Use single space to seprate multiple keyword as #hashtag or @account or both..." autocomplete="off" autofocus="autofocus" type="text" value="" />
            ...
            <div class="container-fluid">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6 pull-right text-right">
                            <p class="muted">© 2017 tushy lover. All rights reserved</p>
                        </div>
                    </div>
            </div>
        </footer> -->
