...
$mysql_credentials = [
   ...
   'database' => 'kafegame_Viewpvpage_bot',
];
...
try {
    ...
    $telegram->enableAdmins([63200004, 103693627, 270783544]);

    // Add the channel you want to manage
    $telegram->setCommandConfig('sendtochannel', ['your_channel' => '@Position']);
    ...
    $telegram->setDownloadPath('../Download-ViewPV-dummy');
    $telegram->setUploadPath('../Upload-ViewPV-dummy');
