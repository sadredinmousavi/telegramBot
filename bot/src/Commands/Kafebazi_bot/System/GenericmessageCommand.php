...
class GenericmessageCommand extends SystemCommand
{
    ...
    public function execute()
    {
        ...
        if ($message) {
            ...
            if (strpos($message->getText(true), 'áíÓÊ ÈÇÒí åÇ')) {
                return $this->getTelegram()->executeCommand("list");
            } else if (strpos($message->getText(true), 'ÑÇåäãÇ')) {
                return $this->getTelegram()->executeCommand("help");
            } else if (strpos($message->getText(true), 'ãäæ')) {
