...
class BannerCommand extends UserCommand
{
    ...
    public function execute()
    {
		...
		$text = 'عکس های پیج های خصوصی اینستاگرام رو تو این ربات میتونی دانلود کنی. 😎😍'.PHP_EOL .PHP_EOL
			.'t.me/Viewpvpage_bot?start=' .base64_encode($user_id) .PHP_EOL .PHP_EOL;
        $data = [
            'chat_id'         => $chat_id,
            //'photo'           => 'AgADBAADaqkxG8iOKVEAAUdn0c5szsRQcrsZAAQonQaU0Ajsc8VLAQABAg',
			'photo'           => 'AgADBAADnakxG8JmSVEgZsWg4jiayIkLoBkABIKGEwzOS5Cmg7YDAAEC',
			'caption'         => $text,
        ];
